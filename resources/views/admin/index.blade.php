                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h1 class="mt-1 mb-3 text-success">{{ $harianMasuk }}</h1>
                                    <div class="mb-0">
                                        <span class="text-danger"> <i class="mdi mdi-arrow-bottom-right"></i> {{ $harianKeluar }}</span>
                                        <span class="text-muted">Keluar Hari ini</span>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h1 class="mt-1 mb-3 text-success">{{ $mingguanMasuk }}</h1>
                                    <div class="mb-0">
                                        <span class="text-danger"> <i class="mdi mdi-arrow-bottom-right"></i> {{ $mingguanKeluar }}</span>
                                        <span class="text-muted">Keluar minggu ini</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h1 class="mt-1 mb-3 text-success">{{ $bulananMasuk }}</h1>
                                    <div class="mb-0">
                                        <span class="text-danger"> <i class="mdi mdi-arrow-bottom-right"></i> {{ $bulananKeluar }} </span>
                                        <span class="text-muted">keluar bulan ini</span>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
